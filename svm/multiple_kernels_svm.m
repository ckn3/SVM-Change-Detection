...
[model, out_param,kerneloption] = epsSVM_mykernel(double(X)',double(X2)', double(X3)',double(L)',in_param);
...
K=0.2*K1+0.4*K2+0.4*K3;%Èý¸öºË indianpines 0.2 0.1 0.7//0.1 0.2 0.7 labels400   paviaU 0.4 0.3 0.3 labels400
