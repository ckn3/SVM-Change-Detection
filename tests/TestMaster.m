...
% %
trial_num = 10;
% if choice3 == 1 && uplift == 0
%     best_param = [0.2,0.13];
%     par = 0;
%     par2 = 2;
% end
prompt4 = 'Enter Points per class for Training (500, 1000, 2000, 5000, 10000) \n';
choice4 = input(prompt4);

dataName = strcat(datasets{choice1},Preprocess{choice2},Task{choice3});
load(strcat(dataName,num2str(choice4),'param'))

clear prompt1 prompt2 prompt3 prompt4
clear datasets Preprocess Task overall_AA overall_CA overall_kappa overall_OA prediction_map
...
for i = 1:7
    ...
    save(strcat(RegionSelected,'_',dataName,num2str(choice4)), 'Prediction','choice4')
end