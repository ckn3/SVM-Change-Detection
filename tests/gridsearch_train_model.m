function Prediction = gridsearch_train_model(HSI,Y2d,K_Known,trial_num,pts_per_class,best_param,par,par2,model)
besta1a2=[];
...
for trial_idx = 1: trial_num
    ...
    in_param.model = model(trial_idx);
    [~, out_param] = classify_prob_test(HSI,train_img,in_param); %% output is probability
