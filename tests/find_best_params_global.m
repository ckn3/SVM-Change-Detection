function [best_param,idx_all, idx_kappa, model] = find_best_params_global(HSI,Y2d,K_Known,trial_num,pts_per_class,n,g)
rng('default')
rng(1) %random seed
...
Data.n = n;
Data.g = g;
[class_label, out_param, bestng, svm_clf] = classify_svm_train(Data,train_img);
model(trial_idx) = svm_clf;
...
[~,idx_all] = max(overall_OA+overall_kappa+overall_AA);
